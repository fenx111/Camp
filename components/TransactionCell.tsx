    ...
    return (
        <View style={{ marginTop: 5}}>
            <View style={{ height: 70, justifyContent: 'center', alignItems: 'center' }}>
                <View style={{ width: '95%', height: '80%', borderRadius: 15, backgroundColor: 'whitesmoke', justifyContent: 'space-between', alignItems: 'center', flexDirection: 'row' }}>
                    ...
                    <View style={{ justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
                        ...
                        <Image source={require('../assets/images/r.png')} style={{ height: 16, width: 16, opacity: 0.5, marginRight: 20, tintColor: style }}></Image>
                    </View>
                </View>
            </View>
        </View>
